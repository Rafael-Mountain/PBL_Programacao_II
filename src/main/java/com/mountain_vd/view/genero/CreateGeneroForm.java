package com.mountain_vd.view.genero;
 ...
 * <p>
 * A classe herda de {@link com.mountain_vd.view.commons.Screen} e permite a criação de um gênero por meio de um formulário interativo.
 * A validação e a criação do gênero são realizadas pela classe {@link com.mountain_vd.controller.action.genero.CreateGeneroAction}.
